...
once we verify our image with named user-management-portal-ui execute below command to start application

docker run -p 3000:3000 user-management-portal-ui
